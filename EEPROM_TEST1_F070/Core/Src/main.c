...
//#define DATA1_ADDR (FLASH_BASE + 0x0800C000) // Example address for data1
//#define DATA2_ADDR (FLASH_BASE + 0x0800C004) // Example address for data2
#define DATA1_ADDR  0x08007000
